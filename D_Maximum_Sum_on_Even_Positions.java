...
public class D_Maximum_Sum_on_Even_Positions{
	...
	static void solve(){
		...
		long sum=0,ans1=0,ans2=0,prefixSum=0;
		...
		out.println( ( Math.max(ans1,ans2)+sum ) );
		out.flush();
